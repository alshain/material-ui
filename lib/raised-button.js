...
var RaisedButton = React.createClass({
  ...
  render: function render() {
    ...
    if (label) {
      var leftPaddingOnIcon = this.props.iconClassName ? { paddingLeft: '8px' } : {};
      labelElement = React.createElement(
        'span',
        { style: this.mergeAndPrefix(styles.label, leftPaddingOnIcon, this.props.labelStyle) },
        label
      );
    }

    var fontIconElement = undefined;
    if (this.props.iconClassName) {
      fontIconElement = React.createElement(FontIcon, {
